...
import { getGF01 } from "@/lib/modules/greentech-foundation-technician/gf-01";
import { getGF02 } from "@/lib/modules/greentech-foundation-technician/gf-02";
import { getGF03 } from "@/lib/modules/greentech-foundation-technician/gf-03";
import { getGF04 } from "@/lib/modules/greentech-foundation-technician/gf-04";
import { getGF05 } from "@/lib/modules/greentech-foundation-technician/gf-05";
import { getGF06 } from "@/lib/modules/greentech-foundation-technician/gf-06";
import { getGF07 } from "@/lib/modules/greentech-foundation-technician/gf-07";
import { getGF08 } from "@/lib/modules/greentech-foundation-technician/gf-08";
import { getGF09 } from "@/lib/modules/greentech-foundation-technician/gf-09";
...
import { getGT204 } from "@/lib/modules/greentech-few-systems-technician/gt2-04";
import { getGT205 } from "@/lib/modules/greentech-few-systems-technician/gt2-05";
import { getGT206 } from "@/lib/modules/greentech-few-systems-technician/gt2-06";
import { getGT207 } from "@/lib/modules/greentech-few-systems-technician/gt2-07";
import { getGT208 } from "@/lib/modules/greentech-few-systems-technician/gt2-08";
import { getGT209 } from "@/lib/modules/greentech-few-systems-technician/gt2-09";
import { getGT210 } from "@/lib/modules/greentech-few-systems-technician/gt2-10";
...
import { getGA01 } from "@/lib/modules/greentech-advanced-systems/ga-01";
import { getGA02 } from "@/lib/modules/greentech-advanced-systems/ga-02";
import { getGA03 } from "@/lib/modules/greentech-advanced-systems/ga-03";
...
import { getGA10 } from "@/lib/modules/greentech-advanced-systems/ga-10";
import { getGA11 } from "@/lib/modules/greentech-advanced-systems/ga-11";
import { getGA12 } from "@/lib/modules/greentech-advanced-systems/ga-12";
...
"PF-01":localizedFoundationGetter("PF-01",getPF01),"PF-02":localizedFoundationGetter("PF-02",getPF02),"PF-03":localizedFoundationGetter("PF-03",getPF03),"PF-04":localizedFoundationGetter("PF-04",getPF04),"PF-05":localizedFoundationGetter("PF-05",getPF05),"PF-06":localizedFoundationGetter("PF-06",getPF06),"PF-07":localizedFoundationGetter("PF-07",getPF07),"PF-08":localizedFoundationGetter("PF-08",getPF08),"PF-09":localizedFoundationGetter("PF-09",getPF09),"PF-10":localizedFoundationGetter("PF-10",getPF10),"PF-11":localizedFoundationGetter("PF-11",getPF11),"PF-12":localizedFoundationGetter("PF-12",getPF12),
...
"GA-01":getGA01,"GA-02":getGA02,"GA-03":getGA03,"GA-04":getGA04,"GA-05":getGA05,"GA-06":getGA06,"GA-07":getGA07,"GA-08":getGA08,"GA-09":getGA09,"GA-10":getGA10,"GA-11":getGA11,"GA-12":getGA12};
